...
import { ShieldCheck, History, Database, AlertCircle, UserX, UserCheck, LoaderCircle, FileDown } from 'lucide-react';
  ...
  const exportToPDF = () => {
    if (!allLogs || allLogs.length === 0) {
      toast({
        variant: "destructive",
        title: "Export Failed",
        description: "There are no visit logs available to export.",
      });
      return;
    }
    ...
    try {
      ...
      doc.setFontSize(14);
      doc.setTextColor(0);
      doc.text('Visit Logs Official Report', 14, 32);
      ...
      autoTable(doc, {
        ...
        didDrawPage: (data) => {
          ...
          doc.text(
            `Page ${data.pageNumber} of ${pageCount} - New Era University Library Systems`,
      ...
      toast({
        ...
        description: "The PDF report has been generated and downloaded.",
      });
    } catch (error: any) {
    ...
    <div className="flex min-h-screen w-full flex-col gradient-bg">
      ...
      <main className="flex-1 p-4 md:p-8 space-y-8 animate-in fade-in duration-700">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <Button 
            onClick={exportToPDF} 
            disabled={isExporting || logsLoading || !allLogs || allLogs.length === 0}
