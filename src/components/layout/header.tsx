      ...
      <div className="ml-auto flex items-center gap-5">
        {isAdmin && (
          <Button 
            variant="ghost" 
            asChild
            className="hidden md:flex gap-2 font-black text-[10px] uppercase tracking-widest hover:bg-primary/[0.1] dark:hover:bg-white/5 rounded-full px-6 h-10 transition-all border border-transparent hover:border-primary/10"
          >
            {isAdminPage ? (
              <Link href="/">
